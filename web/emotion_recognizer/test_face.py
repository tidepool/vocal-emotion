...
def PerformSVM():
	featureData = LoadTrainingDataFromFile('/Users/mayank/Developer/vocal-emotion-test/web/emotion_recognizer/old/mayank.txt')
	...
	testData = FacialFeaturesForPhoto('/Users/mayank/Developer/vocal-emotion-test/web/emotion_recognizer/old/test.jpg')
	# testData['data'] /= normalizingVector
	return numberToEmotion[PredictSVM(m,testData)]
	return
	success = 0
	failure = 0
